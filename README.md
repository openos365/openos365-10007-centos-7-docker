...
docker run -it openos365/openos365-10007-centos-7-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10007-centos-7-docker-main-www:latest
docker run -it openos365/openos365-10007-centos-7-docker-main-www:latest bash
```
